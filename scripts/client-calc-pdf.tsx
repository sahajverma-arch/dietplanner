...
async function main() {
  ...
  // Each category runs its own strategy directly against TDEE/BMR — no rule
  // pre-empts another.
  ...
  if (cat.id === 1) {
    ...
    // Category 4: reverse diet once the gap to TDEE clears the trigger,
    // otherwise straight to maintenance.
